...
class NDCApp extends React.Component {
  ...
  creationVals() {
    ...
    return {
      ...
      // defined" on Design Creation. Computed here instead, where `st` is actually in scope.
      rqActiveCount: (st.runQueue || []).filter(r => r.status === 'Queued' || r.status === 'In Progress').length,
